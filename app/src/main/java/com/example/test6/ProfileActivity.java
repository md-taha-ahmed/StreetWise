...
public class ProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayInfo();
        fillNavigation();
        prof_menubtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(ed_email.getText().toString().isEmpty() || ed_name.getText().toString().isEmpty() || ed_mobile.getText().toString().isEmpty() || ed_username.getText().toString().isEmpty()  || ed_pass.getText().toString().isEmpty()){
...
//        });
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                flag=0;
                if(ed_email.isEnabled() && !ed_email.getText().toString().isEmpty()){
                    flag2=0;
                ...
                if(ed_name.isEnabled() && !ed_name.getText().toString().isEmpty()) {
                    flag2=0;
                    FirebaseFirestore.getInstance()
                            .collection("CUSTOMER")
                            .document(username)
...
//                if(ed_mobile.isEnabled() && !ed_mobile.equals("")) {
//                    FirebaseFirestore.getInstance()
//                            .collection("CUSTOMER")
//                            .document(username)
//                            .update("Mobile", ed_mobile.getText().toString().isEmpty());
//                }
//                else
//                {
//                    flag2=1;
//                    Toast.makeText(getApplicationContext(), "Pls fill the Mobile!", Toast.LENGTH_SHORT).show();
//                }


                if(ed_pass.isEnabled() && !ed_pass.getText().toString().isEmpty()) {
                    flag2=0;
                    FirebaseFirestore.getInstance()
                            .collection("CUSTOMER")
                            .document(username)
