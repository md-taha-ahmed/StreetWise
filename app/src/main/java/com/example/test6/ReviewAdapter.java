...
public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.frevReviewViewHolder> {
    ...
    public class frevReviewViewHolder extends RecyclerView.ViewHolder{
        ...
        public frevReviewViewHolder(@NonNull View itemView) {
            super(itemView);
            mUsername = itemView.findViewById(R.id.frev_tv_username);
            mReview = itemView.findViewById(R.id.frev_tv_review);
            mImage = itemView.findViewById(R.id.frev_profile_image);
            mRating = itemView.findViewById(R.id.frev_tv_rating);
        }
    }
}
